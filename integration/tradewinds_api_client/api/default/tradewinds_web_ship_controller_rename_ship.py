...
from ...models.rename_ship_request import RenameShipRequest
...
def _get_kwargs(
    ship_id: str,
    *,
    body: RenameShipRequest | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    """Rename a ship
     ...
     Changes the name of a ship owned by the current company.

    Args:
        ship_id (str):
        tradewinds_company_id (UUID):
        body (RenameShipRequest | Unset): Request schema to rename a ship.
