...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/warehouses/{warehouse_id}/shrink".format(
...
) -> ChangesetResponse | ErrorResponse | WarehouseResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ChangesetResponse | ErrorResponse | WarehouseResponse]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Downgrade a warehouse
     ...
     Downgrades a warehouse to the previous tier, decreasing its capacity.
...
def sync(
    ...
    *,
    ...
    Returns:
        ChangesetResponse | ErrorResponse | WarehouseResponse
    """
