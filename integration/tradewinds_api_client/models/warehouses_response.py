...
T = TypeVar("T", bound="WarehousesResponse")


@_attrs_define
class WarehousesResponse:
    """Response schema for a list of warehouses.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = Warehouse.from_dict(data_item_data)

            data.append(data_item)

        metadata = PageMetadata.from_dict(d.pop("metadata"))

        warehouses_response = cls(
            data=data,
            metadata=metadata,
        )

        warehouses_response.additional_properties = d
