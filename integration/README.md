# tradewinds-api-client
A client library for accessing Tradewinds API

## Usage
First, create a client:

```python
from tradewinds_api_client import Client
...
```python
from tradewinds_api_client import AuthenticatedClient
...
```python
from tradewinds_api_client.models import MyDataModel
from tradewinds_api_client.api.my_tag import get_my_data_model
from tradewinds_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `tradewinds_api_client.api.default`
